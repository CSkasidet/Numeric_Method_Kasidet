...
import './screen.css';
import { BookFilled,PieChartOutlined,SendOutlined } from '@ant-design/icons';
...
class App extends Component {
  ...
  render() {
    return (
      <Router>
        <Layout>
          <Header className="header" style={{height: "100px",backgroundColor:"#0A0909" }}>
            <div className="headertext">
              <label><SendOutlined  style={{color: "#e89a3c" ,fontSize:"40px", marginRight:"10px"}} />Numerical Method</label>
            </div>
          </Header>
          <Layout>
            
            <Header className="header" style={{backgroundColor:"#e89a3c" ,height:"100"}}>
              <Menu theme="light" mode="horizontal" style={{backgroundColor:"#e89a3c" ,fontSize:"40px"}} >
...
{/*                <SubMenu key="de_submenu" title={<span>Ordinary Differential Equation</span>}>
            ...
            <Layout style={{ padding: '0 25px 25px',backgroundColor:"#0A0909" }}>
          ...
          <Footer style={{ backgroundColor: "#e89a3c", minHeight: 120 }}>
            <p style={{ fontSize: "20px", fontWeight: "bold", color: "black" }}>
              © All Right Reserved<br />

              <p style={{fontSize:"22px", verticalAlign:"text-bottom",color:"#black"}}><BookFilled style={{ fontSize: "30px",color: "black" }} /><a target="_blank" rel="noopener noreferrer" href="http://cs.kmutnb.ac.th/" style={{  textDecoration: "none",color: "black" }}> Department of Computer and Information Science - King Mongkut's University of Technology North Bangkok</a></p>
